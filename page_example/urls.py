...
urlpatterns = [
    ...
    url(r'^load_recent_product/', views.load_recent_product, name='load_recent_product'),
    ...
    url('^admin/admin_filter_pcb_connector', connector_views.admin_filter_connector_pcb,
        name="admin_filter_connector_pcb"),
    url('^admin/admin_filter_cable_connector', connector_views.admin_filter_connector_cable,
        name="admin_filter_connector_cable"),
    url('^admin/admin_load_pcb_connector', connector_views.admin_load_connector_pcb_mod_form,
        name="admin_load_connector_pcb_form"),
    url('^load_cable_connector', connector_views.load_filter_connector_cable,
        name="load_filter_connector_cable"),

    url('^load_pcb_connector', connector_views.load_filter_connector_pcb,
        name='load_filter_connector_pcb'),
    ...
    url('^admin/admin_filter_converter', converter_views.admin_filter_converter,
        name="admin_filter_converter"),
    url('load_filter_converter', converter_views.load_filter_converter,
        name="load_filter_converter"),
    ...
    url(r'^load_filter_cable', cable_views.load_filter_cable, name="load_filter_cable"),

    url(r'^admin/vna_combo_cable_product/', vna_combo_cable_views.admin_vna_combo_cable_product,
        name='admin_vna_combo_cable'),
    url('^admin/add_vna_combo_cable/', vna_combo_cable_views.admin_add_vna_combo_cable,
        name='admin_add_vna_combo_cable'),
    url('^admin/admin_filter_vna_combo_cable', vna_combo_cable_views.admin_filter_vna_combo_cable,
        name="admin_filter_vna_combo_cable"),
    url('^admin/admin_load_vna_combo_cable', vna_combo_cable_views.admin_load_vna_combo_cable_mod_form,
        name="admin_load_vna_combo_cable_form"),
    url('^admin/admin_delete_vna_combo_cable', vna_combo_cable_views.admin_delete_vna_combo_cable,
        name="admin_delete_vna_combo_cable"),
    url(r'^goto_modify_vna_combo_cable/', vna_combo_cable_views.admin_modify_vna_combo_cable,
        name='admin_modify_vna_combo_cable'),
    url(r'^load_vna_filter_combo_cable', vna_combo_cable_views.load_filter_vna_combo_cable,
        name='load_filter_vna_combo_cable'),
    url('^admin/admin_filter_normal_combo_cable', normal_combo_cable_views.admin_filter_normal_combo_cable,
        name="admin_filter_normal_combo_cable"),
    ...
    url(r'^admin/other_product/', other_product_views.admin_other_product_product,
        name="admin_other_product"),
    url('^admin/add_other_product/', other_product_views.admin_add_other_product,
        name='admin_add_other_product'),
    url('^admin/admin_filter_other_product', other_product_views.admin_filter_other_product,
        name="admin_filter_other_product"),
    url('^admin/admin_load_other_product', other_product_views.admin_load_other_product_mod_form,
        name="admin_load_other_product_form"),
    url('^admin/admin_delete_other_product', other_product_views.admin_delete_other_product,
        name="admin_delete_other_product"),
    url(r'^admin/modify_other_product/', other_product_views.admin_modify_other_product,
        name='admin_modify_other_product'),
